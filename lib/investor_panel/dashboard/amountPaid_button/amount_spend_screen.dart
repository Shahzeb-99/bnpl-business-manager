...
import '../../../investor_panel/dashboard/amountPaid_button/customer_screen_monthly_recovery.dart';
...
class _AllAmountSpendState extends State<AllAmountSpend> {
  @override
  void initState() {
    Provider.of<CustomerViewInvestor>(context, listen: false).getThisMonthCustomersRecovery(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Amount Paid : ${Provider.of<CustomerViewInvestor>(context, listen: false).thisMonthCustomers[index].paidAmount} PKR',
                            ),
                          ],
                        )
                      ],
