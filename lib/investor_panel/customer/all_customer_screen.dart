...
import 'package:ecommerce_bnql/investor_panel/model/customers.dart';
...
class _AllCustomersScreenState extends State<AllCustomersScreen> {
  @override
  void initState() {
    if (Provider.of<CustomerViewInvestor>(context, listen: false).option == CustomerFilterOptions.all) {
          ...
          children: [
            ...
            IconButton(
                onPressed: () async {
                  ...
                  final list = Provider.of<CustomerViewInvestor>(context, listen: false).allCustomers;
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: ListView.builder(
            ...
            itemCount: Provider.of<CustomerViewInvestor>(context, listen: false).option == CustomerFilterOptions.all
                ...
                child: InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(
                          backgroundImage: NetworkImage(Provider.of<CustomerViewInvestor>(context, listen: false).option == CustomerFilterOptions.all
                              ? Provider.of<CustomerViewInvestor>(context).allCustomers[index].image
                              : Provider.of<CustomerViewInvestor>(context).thisMonthCustomers[index].image),
                          radius: 30,
                        ),
                        const SizedBox(
                          width: 20,
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              Provider.of<CustomerViewInvestor>(context, listen: false).option == CustomerFilterOptions.all
                                  ? Provider.of<CustomerViewInvestor>(context).allCustomers[index].name
                                  : Provider.of<CustomerViewInvestor>(context).thisMonthCustomers[index].name,
                              style: kBoldText,
                            ),
                            Text(
...
// third overwrite to show query result
  ...
  Widget buildResults(BuildContext context) {
    ...
    for (var fruit in Provider.of<CustomerViewInvestor>(context).allCustomers) {
