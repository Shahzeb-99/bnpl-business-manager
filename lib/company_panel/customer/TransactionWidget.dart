  ...
  Widget build(BuildContext context) {
    return InkWell(onTap: ()async{
      ...
      final date = await service.createPaymentReceipt(
          ...
          Provider.of<CustomerView>(context, listen: false).thisMonthCustomer[widget.index].purchases[widget.productIndex].transactionHistory[widget.paymentIndex].amount,
          Provider.of<CustomerView>(context, listen: false).thisMonthCustomer[widget.index].purchases[widget.productIndex].transactionHistory[widget.paymentIndex].date.toDate());
