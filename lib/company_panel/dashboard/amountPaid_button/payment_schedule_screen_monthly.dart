...
import 'package:ecommerce_bnql/company_panel/dashboard/amountPaid_button/transaction_history_screen_recovery.dart';
...
import '../outstandingAmount_button/payment_schedule_widget_monthly.dart';
...
class _PaymentScheduleScreenMonthlyRecoveryState
  ...
  void initState() {
    if (Provider.of<DashboardView>(context,listen: false).option!=DashboardFilterOptions.all) {
      Provider.of<CustomerView>(context, listen: false).getPaymentScheduleMonthlyRecovery(
          index: widget.index, productIndex: widget.productIndex, option: Provider.of<DashboardView>(context,listen: false).option);
    }else{
